...
def fuzzify(input_dict):
    ...
    cholesterol_dict = fuzzify_cholesterol(float(input_dict['cholestrol']))
    ...
    input_fuzzified = {}
    input_fuzzified.update(age_dict[0])
    input_fuzzified.update(blood_pressure_dict[0])
    input_fuzzified.update(blood_sugar_dict[0])
    input_fuzzified.update(cholesterol_dict[0])
    input_fuzzified.update(heart_rate_dict[0])
    input_fuzzified.update(ecg_dict[0])
    input_fuzzified.update(old_peak_dict[0])
